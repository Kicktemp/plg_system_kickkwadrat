...
$decoration = $this->el('div', [
    ...
    'class' => [
        ...
        'tm-box-decoration-{image_box_decoration: default|primary|secondary|top-left|bottom-left|top-right|bottom-right}',
...
$link = $this->el('a', [
    ...
    'class' => [
        ...
        'tm-box-decoration-inverse {@image_box_decoration_inverse} {@image_box_decoration: default|primary|secondary|top-left|bottom-left|top-right|bottom-right}',
        'uk-inline {@!image_box_decoration: |shadow}',
    ],
